    ...
    case ORDER_DOGS: 
      ...
      if(orderOptions === 'weight_desc'){
        orderDogs = [...state.dogs].sort((a,b) => {
          ...
          const firstWeight = a.weight.split(' - ')[1]|| a.weight.split(' - ')[0];
      ...
      // else if(orderOptions === 'life_span_asc'){
      //   orderDogs = [...state.dogs].sort((a,b) =>{
      //     if(a.life_span || b.life_span ){
      //       const firstNumber = typeof a.life_span === 'string' ? a.life_span.split(' - ')[1] || a.life_span.split(' - ')[0] : a.life_span
      //       const secondNumber = typeof b.life_span === 'string'? b.life_span.split(' - ')[1] || b.life_span.split(' - ')[0] : b.life_span
      //       return firstNumber - secondNumber    
      //     }
      //   })
      // }else if(orderOptions === 'life_span_desc'){
      //   orderDogs = [...state.dogs].sort((a,b) =>{
      //     if(a.life_span || b.life_span ){
      //       const firstNumber = a.life_span.split(' - ')[1] || a.life_span.split(' - ')[0]
      //       const secondNumber = b.life_span.split(' - ')[1] || b.life_span.split(' - ')[0] 
