  ...
  return(
    <div className="form">
      <form className="create" onSubmit={handleSubmit}>
        ...
        <br/>
        <button type="submit" disabled={errors.name || errors.image || errors.heightMin || errors.heightMax || errors.weightMin || errors.weightMax || errors.life_span || errors.temperament }>
          SUBMIT
          </button>
      </form>
    </div>
